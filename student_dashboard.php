    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 min-w-0">
            ...
            <div class="p-10 max-w-[1500px] mx-auto space-y-10">
                ...
                <?php else: ?>
                <div
                    class="bg-white rounded-3xl p-10 border border-slate-100 shadow-lg shadow-slate-100/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <p class="text-[10px] font-black uppercase text-indigo-600 tracking-widest mb-1">C-Familia
                            Portal</p>
                        <h1 class="text-3xl font-extrabold mb-2 tracking-tight">Welcome,
                            <?= explode(' ', $user['name'])[0] ?>!</h1>
                        <p class="text-slate-500 text-lg">Program: <span
                                class="text-slate-800 font-semibold"><?= $enroll['program_type'] ?></span></p>
                    </div>
                    <div class="px-6 py-3 bg-indigo-50 rounded-xl border border-indigo-100 text-center">
                        <span
                            class="text-[11px] font-extrabold text-indigo-800 uppercase tracking-wider block mb-0.5">Enrollment</span>
                        <span class="text-sm font-bold uppercase text-indigo-700"><?= $enroll['status'] ?></span>
                    </div>
                </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white rounded-3xl border border-slate-100 shadow-lg shadow-slate-100/50">
                            ...
                            <div class="p-8 space-y-6">
                                ...
                                <?php endwhile; ?>
                                <?php else: ?>
                                <p class="text-center py-4 text-xs font-bold text-slate-400 italic">No announcements at
                                    this time.</p>
                                <?php endif; ?>
                            </div>
                        </div>
