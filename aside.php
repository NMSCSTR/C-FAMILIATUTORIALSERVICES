...
<aside id="mobileSidebar"
    ...
    <div class="p-6 border-t border-slate-800/80 mt-auto">
        <a href="logout.php" onclick="return confirm('Sign out of the C-Familia admin panel?')" class="flex items-center gap-3 py-3 px-4 rounded-xl font-semibold text-red-400 hover:bg-red-500/10 transition-all border border-transparent hover:border-red-500/10">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
