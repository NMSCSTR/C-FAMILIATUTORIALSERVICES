                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-slate-200 p-6 md:p-10 mb-10">
                    <form action="" method="POST" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-black uppercase text-slate-400 tracking-widest px-1">Target Audience</label>
                                <select name="audience" class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 outline-none transition font-semibold appearance-none">
                                    <option value="General">Landing Page (Public)</option>
