...
<body class="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 antialiased min-h-screen flex flex-col selection:bg-blue-600 selection:text-white transition-colors duration-300">
    ...
    <header class="relative py-24 sm:py-32 overflow-hidden flex-shrink-0 border-b border-slate-100 dark:border-slate-900">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img id="headerBg0" src="passers.jpg" alt="" aria-hidden="true" fetchpriority="high" class="absolute inset-0 w-full h-full object-cover opacity-10 dark:opacity-5 transition-opacity duration-1000">
            <img id="headerBg1" src="passers1.jpg" alt="" aria-hidden="true" loading="lazy" class="absolute inset-0 w-full h-full object-cover opacity-0 transition-opacity duration-1000">
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 text-center lg:text-left grid lg:grid-cols-12 items-center gap-16 z-20">
            <div class="space-y-8 lg:col-span-7">
                ...
                <p class="text-lg sm:text-xl text-slate-700 dark:text-slate-300 max-w-xl mx-auto lg:mx-0 font-semibold leading-relaxed">
                    Board exam review programs for future criminologists — with campuses in Ozamiz, Oroquieta, and Tubod.
                </p>
                <p class="text-base sm:text-lg italic text-slate-500 dark:text-slate-400 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
            ...
            <div class="hidden lg:block lg:col-span-5">
                <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-10 rounded-3xl border border-slate-200 dark:border-slate-800 relative overflow-hidden shadow-xl">
                    ...
                    <div class="flex items-center gap-5 mb-8">
                        ...
                        <div>
                            <p class="text-slate-900 dark:text-white text-2xl font-[900] tracking-tight"><?= $display_rate ?> Passing Rate</p>
                            <p class="text-slate-500 dark:text-slate-400 text-sm font-semibold"><?= $total_passers ?>+ Certified Passers</p>
                        </div>
                    </div>
                    <div class="space-y-4">
                ...
                <div class="bg-slate-50/50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-900 hover:border-slate-200 dark:hover:border-slate-800 p-8 rounded-3xl group hover:bg-white dark:hover:bg-slate-900 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-slate-950/50 hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-5 mb-8">
                        <div class="relative flex-shrink-0">
                            <img src="<?= htmlspecialchars(thumb_url($photoPath, 160), ENT_QUOTES, 'UTF-8') ?>" alt="Portrait of <?= htmlspecialchars($top['name'], ENT_QUOTES, 'UTF-8') ?>, top passer in <?= htmlspecialchars($top['program'], ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='assets/img/avatar-placeholder.svg'" loading="lazy" decoding="async" width="80" height="80" class="w-20 h-20 rounded-2xl object-cover ring-4 ring-slate-100 dark:ring-slate-800 shadow-md transition-transform duration-500 group-hover:scale-105">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    ...
                    <div class="gallery-item relative aspect-[4/3] rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-900 shadow-sm hover:shadow-xl hover:shadow-slate-200/40 transition-all hover:-translate-y-1 <?= $index > 0 ? 'gallery-extra hidden sm:block' : '' ?>">
                        <button type="button" class="gallery-lightbox-trigger group absolute inset-0 w-full h-full focus:ring-2 focus:ring-emerald-500/40 focus:ring-inset" data-gallery-src="<?= htmlspecialchars($img_path, ENT_QUOTES, 'UTF-8') ?>" data-gallery-caption="<?= htmlspecialchars($caption, ENT_QUOTES, 'UTF-8') ?>">
                            <img src="<?= htmlspecialchars(thumb_url($img_path, 640), ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars($caption) ?>" loading="lazy" decoding="async" width="640" height="480" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
    ...
    <section id="passers" class="py-24 sm:py-32 bg-white dark:bg-slate-950 px-4 sm:px-6 border-b border-slate-100 dark:border-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 transition-all duration-300 hover:-translate-y-1.5 text-center group flex flex-col justify-between">
                <div>
                    <img src="<?= htmlspecialchars(thumb_url($pPath, 160), ENT_QUOTES, 'UTF-8') ?>" alt="Portrait of <?= htmlspecialchars($passer['name'], ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='assets/img/avatar-placeholder.svg'" loading="lazy" decoding="async" width="80" height="80" class="w-20 h-20 rounded-full mx-auto mb-4 object-cover border-4 border-slate-50 dark:border-slate-950 group-hover:scale-105 transition-transform shadow-inner">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-slate-50/60 dark:bg-slate-900/60 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 relative group hover:bg-white dark:hover:bg-slate-900 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-slate-950/50 hover:-translate-y-1">
                    ...
                    <div class="relative z-10 flex flex-col h-full justify-between">
                        <p class="text-slate-600 dark:text-slate-400 italic leading-relaxed text-sm sm:text-base mb-8 line-clamp-3 font-medium">
                            <?= htmlspecialchars($row['content']) ?>
                        </p>
                        <div class="flex items-center gap-4 border-t border-slate-100 dark:border-slate-800 pt-6">
                            <img src="<?= htmlspecialchars(thumb_url($userPic, 96), ENT_QUOTES, 'UTF-8') ?>" alt="Photo of <?= htmlspecialchars(trim($row['firstname'] . ' ' . $row['lastname']), ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='assets/img/avatar-placeholder.svg'" loading="lazy" decoding="async" width="48" height="48" class="w-12 h-12 rounded-xl object-cover ring-4 ring-white dark:ring-slate-950 shadow-sm flex-shrink-0">
                            <div class="min-w-0">
...
<section id="contact" class="py-24 sm:py-32 px-4 sm:px-6 bg-slate-50 dark:bg-slate-900/40 border-t border-slate-200/60 dark:border-slate-900 w-full relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-start relative z-10">
        ...
        <div class="space-y-10">
            ...
            <div class="space-y-4">
                ...
                <div class="group flex items-start gap-5 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900">
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center gap-3 flex-wrap">
                            <p class="font-bold text-slate-900 dark:text-white text-sm tracking-wide uppercase">Ozamiz Main Branch</p>
                        ...
                        <p class="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Ozamiz City, Philippines, 7200</p>
                    </div>
                </div>
                ...
                <div class="group flex items-start gap-5 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900">
                    ...
                    <div class="space-y-1">
                        <p class="font-bold text-slate-900 dark:text-white text-sm tracking-wide uppercase">Oroquieta Campus</p>
                        <p class="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Oroquieta City, Misamis Occidental</p>
                    </div>
                </div>
                ...
                <div class="group flex items-start gap-5 p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-200 dark:hover:border-blue-900">
                    ...
                    <div class="space-y-1">
                        <p class="font-bold text-slate-900 dark:text-white text-sm tracking-wide uppercase">Tubod Campus</p>
                        <p class="text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base">Tubod, Lanao Del Norte</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/40 dark:shadow-slate-950/50 relative">
            ...
            <div class="space-y-4">
                <!-- Phone Card -->
                <a href="tel:09101676805" class="group flex items-center gap-5 p-5 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:bg-blue-50/50 dark:hover:bg-blue-950/20 hover:border-blue-100 dark:hover:border-blue-900 hover:-translate-y-0.5">
    ...
    <footer class="bg-white dark:bg-slate-950 pt-20 pb-10 px-4 sm:px-6 text-slate-900 dark:text-white overflow-hidden relative mt-auto border-t border-slate-200 dark:border-slate-900">
        ...
        <div class="max-w-7xl mx-auto text-center mb-6 relative">
            <p class="inline-flex items-center gap-2 text-xs font-bold text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-4 py-2 rounded-xl backdrop-blur-sm shadow-inner">
                Developed by 
    ...
    <?php foreach ($announcements as $ann):
        $detail_badge = $ann['category'] === 'Urgent'
            ? 'text-rose-600 bg-rose-50 border-rose-100 dark:bg-rose-950/40 dark:border-rose-900'
            : 'text-slate-400 bg-slate-50 border-slate-100 dark:bg-slate-900 dark:border-slate-800';
    ?>
    <div id="ann-detail-source-<?= (int) $ann['id'] ?>" class="hidden">
        <div class="flex items-center gap-2 mb-4 flex-wrap">
            <p class="text-blue-600 dark:text-blue-400 font-black text-[10px] uppercase tracking-wider"><?= date('M d, Y', strtotime($ann['created_at'])) ?></p>
            <?php if (!empty($ann['category'])): ?>
            <span class="text-[9px] font-black uppercase tracking-wider <?= $detail_badge ?> px-2 py-0.5 rounded-md border"><?= htmlspecialchars($ann['category']) ?></span>
            <?php endif; ?>
        </div>
        <h4 class="text-2xl font-bold text-slate-900 dark:text-white leading-snug mb-4"><?= htmlspecialchars($ann['title']) ?></h4>
        <div class="text-slate-600 dark:text-slate-400 leading-relaxed text-sm font-medium whitespace-pre-line"><?= htmlspecialchars($ann['message']) ?></div>
    </div>
    <?php endforeach; ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl flex flex-col justify-between shadow-sm">
                        <div class="flex items-center gap-4 mb-5">
                            <img src="<?= htmlspecialchars(thumb_url($photoPath, 320), ENT_QUOTES, 'UTF-8') ?>" alt="Portrait of <?= htmlspecialchars($top['name'], ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='assets/img/avatar-placeholder.svg'" loading="lazy" decoding="async" width="56" height="56" class="w-14 h-14 rounded-xl object-cover ring-2 ring-slate-100 dark:ring-slate-800">
                            <div class="min-w-0">
            ...
            <div class="p-8 overflow-y-auto bg-slate-50 dark:bg-slate-950">
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    ...
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 transition-all text-center group flex flex-col justify-between">
                        <div>
                            <img src="<?= htmlspecialchars(thumb_url($pPath, 320), ENT_QUOTES, 'UTF-8') ?>" alt="Portrait of <?= htmlspecialchars($passer['name'], ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='assets/img/avatar-placeholder.svg'" loading="lazy" decoding="async" width="64" height="64" class="w-16 h-16 rounded-full mx-auto mb-3 object-cover border-4 border-slate-50 dark:border-slate-950 shadow-inner">
